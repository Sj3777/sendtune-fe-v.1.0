      ...
      <div className="flex flex-1 justify-center items-center text-center text-white ">
        <form className="mt-4 w-full mx-20 space-y-6 " action="#" method="POST">
          ...
          <div className="flex justify-center items-center">
            <button
              type="submit"
              className="w-40 py-3 px-4 mt-12 border border-transparent text-sm font-medium rounded-md text-white bg-red-500 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
